...
$('#design-button').click(function () {
  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      window.location.href = '/mock_display?mockup_url=' + data.mockup_url + '&product_info=' + encodeURIComponent(JSON.stringify(data.product_info)) + '&variant=' + encodeURIComponent(JSON.stringify(data.variant));
